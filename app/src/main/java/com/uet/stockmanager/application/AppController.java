...
public class AppController extends Application {
    ...
    private void mockData() {
        ...
        insertSale(p2, p2_id, 2, "1481200430778"); // 8/12/2016
        insertSale(p7, p7_id, 1, "1478694861275"); // 09/11/2016
        insertSale(p5, p5_id, 2, "1476102892268"); // 10/10/2016
        insertSale(p11, p11_id, 1, "1472906121510"); // 03/09/2016
        insertSale(p9, p9_id, 2, "1471523756803"); // 18/08/2016
        insertSale(p14, p14_id, 1, "1469622978667"); // 27/07/2016
        insertSale(p20, p20_id, 2, "1464784598245"); // 1/06/2016
        insertSale(p18, p18_id, 1, "1462106286717"); // 1/05/2016
        insertSale(p4, p4_id, 2, "1491568881227"); // 7/04/2017
        insertSale(p6, p6_id, 1, "1483274559726"); // 1/01/2017
        insertSale(p12, p12_id, 2, "1472820230889"); // 2/09/2016
        insertSale(p3, p3_id, 1, "1479646014419"); // 20/11/2016
