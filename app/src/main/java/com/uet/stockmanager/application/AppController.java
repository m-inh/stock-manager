...
public class AppController extends Application {
    ...
    private void mockData() {
        ...
        insertSale(p9, p9_id, 8, "1489594328220"); // 15/3/2017
        insertSale(p3, p3_id, 15, "1488989564454"); // 8/3/2017
        ...
        insertSale(p18, p18_id, 10, "1483373676019"); // 2/1/2017
        insertSale(p6, p6_id, 4, "1483274559726"); // 1/01/2017

        insertSale(p2, p2_id, 10, "1481200430778"); // 8/12/2016

        insertSale(p7, p7_id, 9, "1478694861275"); // 09/11/2016
        insertSale(p3, p3_id, 8, "1479646014419"); // 20/11/2016

        insertSale(p5, p5_id, 2, "1476102892268"); // 10/10/2016
        insertSale(p17, p17_id, 5, "1476980217887"); // 20/10/2016

        insertSale(p11, p11_id, 12, "1472906121510"); // 03/09/2016
        insertSale(p12, p12_id, 6, "1472820230889"); // 2/09/2016
        insertSale(p13, p13_id, 4, "1473956357675"); // 15/09/2016

        insertSale(p9, p9_id, 11, "1471523756803"); // 18/08/2016
        insertSale(p16, p16_id, 4, "1471623632419"); // 19/08/2016
        insertSale(p8, p8_id, 3, "1470068494376"); // 1/08/2016

        insertSale(p14, p14_id, 10, "1469622978667"); // 27/07/2016
        insertSale(p10, p10_id, 4, "1467390125297"); // 1/07/2016
        insertSale(p15, p15_id, 7, "1468599768632"); // 15/07/2016
        insertSale(p19, p19_id, 6, "1468859004642"); // 15/07/2016

        insertSale(p20, p20_id, 5, "1464784598245"); // 1/06/2016
        insertSale(p3, p3_id, 3, "1466267084946"); // 18/06/2016
        insertSale(p5, p5_id, 5, "1465403113176"); // 8/06/2016

        insertSale(p18, p18_id, 5, "1462106286717"); // 1/05/2016
        insertSale(p1, p1_id, 5, "1462724732410"); // 8/05/2016
        insertSale(p8, p8_id, 4, "1462897557437"); // 10/05/2016
